  ...
  - Outboundするとき
    - Span ID 伝搬する。
      - 基本はHeader。（ダメなら、body？）
        - gRPC: Header
        - kafka: Header
- 問題は、ソリューションがいっぱいあって、SDKがそれぞれ異なる。
- OpenCensus
  - 一番しっかりできていると思っている。
...
<script async class="speakerdeck-embed" data-id="e03f7c5484e84f7eac649202ea4c2327" data-ratio="1.33333333333333" src="//speakerdeck.com/assets/embed.js"></script>
